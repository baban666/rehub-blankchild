        ...
        <div class="logo-section rh-flex-center-align tabletblockdisplay">
            ...
            <div class="hideontablet">
               <div class="contacts-header-top">
            	<?php if(rehub_option('rehub_top_line_content_1')) : ?>
                        <div class="contact-header"><?php echo do_shortcode(rehub_option('rehub_top_line_content_1'));?></div>
                <?php endif; ?>
          
            	<?php if(rehub_option('rehub_top_line_content_2')) : ?>
                        <div class="contact-header"><?php echo do_shortcode(rehub_option('rehub_top_line_content_2'));?></div>
                <?php endif; ?>
               </div>  
            </div>
