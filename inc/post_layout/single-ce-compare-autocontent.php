                    ...
                    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                        ...
                        <article <?php post_class($postclasses); ?> id="post-<?php the_ID(); ?>">
                                ...
                                <?php if( $flipkart_specification):?>
                                    ...
                                    <div class="rh-tabletext-block-heading"><span class="toggle-this-table"></span><h4><?php esc_html_e('Specification', 'rehub-theme');?></h4></div>  
                                ...
                                <?php if(!empty($youtube_key)):?>
                                    <div class="rh-tabletext-block">
                                    <div class="rh-tabletext-block-heading"><span class="toggle-this-table"></span><h4><?php esc_html_e('Video', 'rehub-theme');?></h4></div>  
                                    <div class="rh-tabletext-block-wrapper">                          
                                ...
                                <?php if(!empty($googlebook_key)):?>
                                    <div class="rh-tabletext-block">
                                    <div class="rh-tabletext-block-heading"><span class="toggle-this-table"></span><h4><?php esc_html_e('Manuals', 'rehub-theme');?></h4></div>  
                                    <div class="rh-tabletext-block-wrapper">                          
                                ...
                                <?php if(!empty($googlenews)):?>
                                    <div class="rh-tabletext-block">
                                    <div class="rh-tabletext-block-heading"><span class="toggle-this-table"></span><h4><?php esc_html_e('World News', 'rehub-theme');?></h4></div>  
                                    <div class="rh-tabletext-block-wrapper">                          
                                ...
                                <?php if($feedback_true):?>
                                    <div class="rh-tabletext-block">
                                    <div class="rh-tabletext-block-heading"><span class="toggle-this-table"></span><h4><?php esc_html_e('Feedbacks', 'rehub-theme');?></h4></div>  
                                    <div class="rh-tabletext-block-wrapper">                          
                                        <?php if ($amazon_rev):?>
                                ...
                                <div class="rh-tabletext-block">
                                <div class="rh-tabletext-block-heading"><span class="toggle-this-table"></span><h4><?php esc_html_e('Description and Review', 'rehub-theme');?></h4></div>  
                                <div class="rh-tabletext-block-wrapper">                          
                                    <?php the_content(); ?>
                                </div>                               
                                </div> 
