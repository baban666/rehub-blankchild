...
<div class="rh-container"> 
    <div class="rh-content-wrap clearfix">
        ...
        <div class="main-side clearfix<?php if (rehub_option('category_layout') == 'gridfull' || rehub_option('category_layout') == 'dealgridfull' || rehub_option('category_layout') == 'compactgridfull' || rehub_option('category_layout') == 'columngridfull' || rehub_option('category_layout') == 'cardblogfull') : ?> full_width<?php endif ;?>">
            <div class="wpsm-title news"><h5><?php single_cat_title(); ?></h5></div>
            <?php if( !is_paged()) : ?><article class='top_rating_text news post'><?php echo category_description(); ?></article><?php endif ;?>
    ...
    <?php if ($post_count == 0 || rehub_option('category_layout') == 'cardblog' || rehub_option('category_layout') == 'cardblogfull') :?>
    <div class="rh-container">
        <div class="grid-wrap">
